...
AppId={{F5F15475-B7D3-4F3D-85AD-FA6A6ABADCCF}}
; Standard app data stuff
; Change GameTestInstall to your game name
AppName=Refactory
AppVerName=Refactory Version 0.1
...
DefaultDirName={pf}\DigiPen\Refactory
; Start menu directory
DefaultGroupName=DigiPen\Refactory
; Output directory for the installer.
OutputDir=.\INSTALLER
; Setup executable installer
OutputBaseFilename=Refactory_Setup
...
SetupIconFile=GAMEDIRECTORY\art_assets\Block.ico
...
Source: .\REDIST\vc_redist.x86.exe; DestDir: {tmp}; Flags: ignoreversion
...
[Icons]
IconFileName: {app}\art_assets\Block.ico; Name: {group}\Refactory; Filename: {app}\Refactory.exe; WorkingDir: {app}
IconFileName: {app}\art_assets\Block.ico; Name: {group}\{cm:UninstallProgram,Refactory}; Filename: {uninstallexe}
IconFileName: {app}\art_assets\Block.ico; Name: {commondesktop}\Refactory; Filename: {app}\Refactory.exe; Tasks: desktopicon; WorkingDir: {app}
...
[Run]
Filename: {tmp}\vc_redist.x86.exe; Parameters: /install /quiet /norestart; StatusMsg: Installing Visual C++ 2015 Redistributable...
;Filename: {tmp}\dxwebsetup.exe; Parameters: /q; StatusMsg: Installing DirectX...
Filename: {app}\Refactory.exe; Description: {cm:LaunchProgram,Refactory}; Flags: nowait postinstall skipifsilent
