...
/*!
\file   Logger.h
\author Philip Nygard
\par    email: philip.n\@digipen.edu
\par    Output Logger Header file
\date   11/22/2016
\brief  
  This file declares functions used with the Logger dynamically linked library.
  Functions in this file define the logger API calls and useful enumerations
  for use with it. Functions include:
  
  - Logging messages to the output log 
  - Setting the output file for the logger (defaults to stdout)
  - Setting the priority levels for the logger (defaults to 
